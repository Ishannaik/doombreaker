...
Optional daily time limit (off by default): set minutes per day in the popup. Active scrolling time is counted across all sites; when the budget runs out the page pins at full break with the feed-kill until the local day rolls over.
